...
| Real functionality | 5,916 working patterns |
...
| **5,916 patterns** | Largest coverage in Solana ecosystem |
...
├── packages/
│   ├── cli/               ← Main product
│   │   ├── src/patterns/  ← 5,916 vulnerability detectors
│   │   └── src/test/      ← Test suite
...
3. **Implementation** — Agent wrote all 5,916 patterns
