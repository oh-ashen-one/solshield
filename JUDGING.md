...
| Real functionality | 6,800+ working patterns |
...
| **6,800+ patterns** | Largest coverage in Solana ecosystem |
...
├── packages/
│   ├── cli/               ← Main product
│   │   ├── src/patterns/  ← 6,800+ vulnerability detectors
│   │   └── src/test/      ← Test suite
...
3. **Implementation** — Agent wrote all 6,800+ patterns
