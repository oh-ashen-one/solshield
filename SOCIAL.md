...
### Thread Version
```
🧵 We built an AI that audits Solana smart contracts
...
#Solana #SmartContracts #Security #AI #Audit
```
...
```
#Solana #SmartContracts #Security #Audit #AI #Web3 #DeFi #Blockchain #CyberSecurity #OpenSource
```
