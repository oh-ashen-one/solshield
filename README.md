...
[![Commands](https://img.shields.io/badge/CLI%20commands-16-purple.svg)](#cli)
...
- [x] **16 CLI commands** — audit, score, badge, fetch, github, watch, ci, stats, list, compare, check, report, certificate, init, parse, programs
