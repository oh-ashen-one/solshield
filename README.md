...
[![Patterns](https://img.shields.io/badge/patterns-5400%2B-blue.svg)](#vulnerability-patterns)
...
2. **Detects** vulnerabilities using **5,400+ specialized patterns**
...
> **5,400+ patterns** covering Core Security, CPI, DeFi, NFT, Token, PDA, Anchor, historical exploit signatures, and more.
